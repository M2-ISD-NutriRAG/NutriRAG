...
CREATE TABLE IF NOT EXISTS ${DATABASE_NAME}.PUBLIC.MESSAGES (
    ...
    ROLE VARCHAR(16777216) NOT NULL, -- 'user' or 'assistant'
    CONTENT VARCHAR(16777216) NOT NULL,
    THREAD_ID INTEGER NULL, -- Snowflake Cortex Agent thread ID
    MESSAGE_ID INTEGER NULL, -- Snowflake Cortex Agent message ID
