...
-- Usage: Replace NUTRIRAG_PROJECT and NUTRIRAG_PROJECT with actual values
-- Or use with a script that substitutes these variables

-- Create Warehouse
CREATE WAREHOUSE IF NOT EXISTS NUTRIRAG_PROJECT;

-- Create Database
CREATE DATABASE IF NOT EXISTS NUTRIRAG_PROJECT;

-- Create RAW
CREATE SCHEMA IF NOT EXISTS RAW WITH managed access;

CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.RAW.CLEANED_INGREDIENTS (
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.CLEANED.INGREDIENTS_MATCHING (
	ID NUMBER(38,0),
	INGREDIENT VARCHAR(16777216),
	NDB_NO VARCHAR(16777216)
);

CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.CLEANED.INGREDIENTS_QUANTITY (
	ID NUMBER(38,0),
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.CLEANED.INGREDIENTS_TAGGED (
	NDB_NO VARCHAR(16777216),
	DESCRIP VARCHAR(16777216),
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.CLEANED.RECIPES_SAMPLE_50K (
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.DEV_SAMPLE.RECIPES_SAMPLE (
	NAME VARCHAR(16777216),
	ID NUMBER(38,0),
	MINUTES NUMBER(38,0),
	CONTRIBUTOR_ID NUMBER(38,0),
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.DEV_SAMPLE.RECIPES_SAMPLE_TEST (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	MINUTES NUMBER(38,0),
	CONTRIBUTOR_ID NUMBER(38,0),
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.DEV_SAMPLE.RECIPES_UNIFIED_EMBEDDINGS (
	NAME VARCHAR(16777216),
	ID NUMBER(38,0),
	MINUTES NUMBER(38,0),
	CONTRIBUTOR_ID NUMBER(38,0),
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.DEV_SAMPLE.RECIPE_EMBEDDINGS (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	MINUTES NUMBER(38,0),
	CONTRIBUTOR_ID NUMBER(38,0),
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.DEV_SAMPLE.RECIPE_EMBEDDINGS_50K (
	NAME VARCHAR(16777216),
	ID NUMBER(38,0),
	MINUTES NUMBER(38,0),
	CONTRIBUTOR_ID NUMBER(38,0),
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.ENRICHED.RECIPES_SAMPLE_50K (
	NAME VARCHAR(16777216),
	ID NUMBER(38,0),
	MINUTES NUMBER(38,0),
	CONTRIBUTOR_ID NUMBER(38,0),
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.ENRICHED.INGREDIENTS (
	NDB_NO VARCHAR(16777216),
	DESCRIP VARCHAR(16777216),
	ENERGY_KCAL NUMBER(38,15),
	PROTEIN_G NUMBER(38,2),
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.ANALYTICS.HIST_SEARCH (
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.ANALYTICS.HIST_TRANSFORMATIONS (
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.ANALYTICS.INGREDIENTS_WITH_CLUSTERS (
	NDB_NO VARCHAR(16777216),
	DESCRIP VARCHAR(16777216),
	ENERGY_KCAL NUMBER(38,15),
	PROTEIN_G NUMBER(38,2),
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.PUBLIC.CONVERSATIONS (
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.PUBLIC.MESSAGES (
	ID VARCHAR(16777216) DEFAULT UUID_STRING(),
	CONVERSATION_ID VARCHAR(16777216),
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.PUBLIC.USER_SESSIONS (
...
CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.VECTORS.RECIPE_EMBEDDINGS (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	EMBEDDING VECTOR(FLOAT, 768)
);

CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.VECTORS.RECIPE_EMBEDDINGS_E5_BASE_V2 (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	EMBEDDING VECTOR(FLOAT, 768)
);

CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.VECTORS.RECIPE_EMBEDDINGS_NV_EMBED_QA_4 (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	EMBEDDING VECTOR(FLOAT, 1024)
);

CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.VECTORS.RECIPE_EMBEDDINGS_SNOWFLAKE_ARCTIC_EMBED_M (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	EMBEDDING VECTOR(FLOAT, 768)
);

CREATE TABLE IF NOT EXISTS NUTRIRAG_PROJECT.VECTORS.RECIPE_EMBEDDINGS_SNOWFLAKE_ARCTIC_EMBED_M_V1_5 (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	EMBEDDING VECTOR(FLOAT, 768)
);
