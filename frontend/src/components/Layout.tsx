import { MessageSquare, LogOut, ChevronDown, Trash2, Plus, LayoutDashboard } from 'lucide-react'
      ...
      <aside className="hidden md:flex w-64 flex-col border-r bg-muted/20">
        <div className="p-4 flex flex-col gap-3">
            ...
            <Button
                ...
                className={cn(
                    "w-full justify-start gap-3 rounded-xl py-6 transition-all",
                    isDashboardActive
                        ? "bg-white shadow-sm text-primary ring-1 ring-black/5"
                        : "hover:bg-background/50 text-muted-foreground hover:text-foreground"
                )}
            >
                <LayoutDashboard className={cn("h-5 w-5", isDashboardActive ? "text-primary" : "")} />
            ...
            <Button
                ...
                variant="outline"
                className="w-full justify-start gap-2 border-dashed border-2 hover:border-primary/50 hover:bg-primary/5 transition-all group rounded-xl py-6"
            >
