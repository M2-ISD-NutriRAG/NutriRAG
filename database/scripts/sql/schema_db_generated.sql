-- Auto-generated from schema_db_template.sql
-- WAREHOUSE: NUTRIRAG_PROJECT_TEST
-- DATABASE: NUTRIRAG_PROJECT_TEST
-- Generated: Sat Jan  3 11:59:12 CET 2026

-- NutriRAG SCHEMA IF NOT EXISTS Creation Script
-- This script uses environment variables for flexibility
-- Usage: Replace NUTRIRAG_PROJECT_TEST and NUTRIRAG_PROJECT_TEST with actual values
-- Or use with a script that substitutes these variables

-- Create Warehouse
CREATE WAREHOUSE IF NOT EXISTS NUTRIRAG_PROJECT_TEST;

-- Create Database
CREATE DATABASE IF NOT EXISTS NUTRIRAG_PROJECT_TEST;

create SCHEMA IF NOT EXISTS CLEANED;

create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.CLEANED.INGREDIENTS_MATCHING (
	ID NUMBER(38,0),
	INGREDIENT VARCHAR(16777216),
	NDB_NO VARCHAR(16777216)
);
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.CLEANED.INGREDIENTS_TAGGED (
	NDB_NO VARCHAR(16777216),
	...
	IS_SEAFOOD BOOLEAN,
	IS_GLUTEN BOOLEAN,
	IS_VEGETABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST..BOOLEAN,
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.DEV_SAMPLE.RECIPES_SAMPLE (
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.DEV_SAMPLE.RECIPES_SAMPLE_50K (
	NAME VARCHAR(16777216),
	ID NUMBER(38,0),
	MINUTES NUMBER(38,0),
	CONTRIBUTOR_ID NUMBER(38,0),
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.DEV_SAMPLE.RECIPES_SAMPLE_TEST (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	MINUTES NUMBER(38,0),
	CONTRIBUTOR_ID NUMBER(38,0),
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.DEV_SAMPLE.RECIPES_UNIFIED_EMBEDDINGS (
	NAME VARCHAR(16777216),
	ID NUMBER(38,0),
	MINUTES NUMBER(38,0),
	CONTRIBUTOR_ID NUMBER(38,0),
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.DEV_SAMPLE.RECIPE_EMBEDDINGS (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	MINUTES NUMBER(38,0),
	CONTRIBUTOR_ID NUMBER(38,0),
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.DEV_SAMPLE.RECIPE_EMBEDDINGS_50K (
	NAME VARCHAR(16777216),
	ID NUMBER(38,0),
	MINUTES NUMBER(38,0),
	CONTRIBUTOR_ID NUMBER(38,0),
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.ENRICHED.NUTRIRAG_PROJECT.ENRICHED.RECIPES_SAMPLE_50K (
	NAME VARCHAR(16777216),
	ID NUMBER(38,0),
	MINUTES NUMBER(38,0),
	CONTRIBUTOR_ID NUMBER(38,0),
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.ANALYTICS.INGREDIENTS_WITH_CLUSTERS (
	NDB_NO VARCHAR(16777216),
	DESCRIP VARCHAR(16777216),
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.RAW.CLEANED_INGREDIENTS (
	NDB_NO VARCHAR(16777216),
	DESCRIP VARCHAR(16777216),
	ENERGY_KCAL NUMBER(38,15),
	PROTEIN_G NUMBER(38,2),
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.RAW.INGREDIENTS_MATCHING (
	RECIPE_ID NUMBER(38,0),
	INGREDIENT_FROM_RECIPE_NAME VARCHAR(16777216),
	INGREDIENT_ID VARCHAR(16777216)
);
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.RAW.INGREDIENTS_QUANTITY (
	ID NUMBER(38,0),
	INGREDIENTS VARCHAR(16777216),
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.RAW.RAW_INTERACTION_10K (
	USER_ID NUMBER(38,0),
	RECIPE_ID NUMBER(38,0),
	DATE DATE,
	RATING NUMBER(38,0),
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.RAW.RAW_RECIPES_10K (
	NAME VARCHAR(16777216),
	ID NUMBER(38,0),
	MINUTES NUMBER(38,0),
	CONTRIBUTOR_ID NUMBER(38,0),
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.RAW.RAW_RECIPES_110K (
	NAME VARCHAR(16777216),
	ID NUMBER(38,0),
	MINUTES NUMBER(38,0),
	CONTRIBUTOR_ID NUMBER(38,0),
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.RAW.RECIPES_ENHANCED_V2 (
	R_ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	ID NUMBER(38,0),
	MINUTES NUMBER(38,0),
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.RAW.RECIPES_W_SEARCH_TERMS (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	DESCRIPTION VARCHAR(16777216),
	INGREDIENTS ARRAY,
...
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.VECTORS.RECIPE_EMBEDDINGS (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	EMBEDDING VECTOR(FLOAT, 768)
);
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.VECTORS.RECIPE_EMBEDDINGS_E5_BASE_V2 (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	EMBEDDING VECTOR(FLOAT, 768)
);
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.VECTORS.RECIPE_EMBEDDINGS_NV_EMBED_QA_4 (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	EMBEDDING VECTOR(FLOAT, 1024)
);
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.VECTORS.RECIPE_EMBEDDINGS_SNOWFLAKE_ARCTIC_EMBED_M (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	EMBEDDING VECTOR(FLOAT, 768)
);
create TABLE IF NOT EXISTS NUTRIRAG_PROJECT_TEST.VECTORS.RECIPE_EMBEDDINGS_SNOWFLAKE_ARCTIC_EMBED_M_V1_5 (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	EMBEDDING VECTOR(FLOAT, 768)
);