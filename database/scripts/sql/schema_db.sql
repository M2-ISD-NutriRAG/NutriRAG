create or replace warehouse NUTRIRAG_PROJECT_TEST;

create or replace database NUTRIRAG_PROJECT_TEST;
...
create or replace TABLE NUTRIRAG_PROJECT_TEST.ENRICHED.RECIPES_SAMPLE_50K (
	NAME VARCHAR(16777216),
	ID NUMBER(38,0),
	MINUTES NUMBER(38,0),
	CONTRIBUTOR_ID NUMBER(38,0),
...
create or replace TABLE NUTRIRAG_PROJECT_TEST.ANALYTICS.INGREDIENTS_WITH_CLUSTERS (
	NDB_NO VARCHAR(16777216),
	DESCRIP VARCHAR(16777216),
...
create or replace TABLE RECIPES_ENHANCED_V2 (
	R_ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	ID NUMBER(38,0),
	MINUTES NUMBER(38,0),
...
create or replace TABLE RECIPES_W_SEARCH_TERMS (
	ID NUMBER(38,0),
	NAME VARCHAR(16777216),
	DESCRIPTION VARCHAR(16777216),
	INGREDIENTS ARRAY,
