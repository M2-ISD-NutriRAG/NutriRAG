...
class TransformService:
        ...
        try:
            ...
            FROM (
                ...
                WHERE 
                    ...
                    OR LOWER(im."INGREDIENT") LIKE '%{safe_ingredient.lower()}%'
            ) AS result
            """
            ...
            if result:
                ...
                if result_data:
                    ...
                    print(f" Ingrédient trouvé: {ingredient_name} → {result_data['name']}")
                    return result_data
            ...
            print(f"❌_get_ingredient : Erreur recherche ingrédient '{ingredient_name}': {e}")
            return None
    ...
    def calculer_nutrition_recette(self, ingredient_list: List[str], ingredient_quantity: List[str]) -> NutritionDelta:
        ...
        for ingredient, qty in zip(ingredient_list, ingredient_quantity):
            ...
            if ingredient_data:
                ...
                saturated_fat = ceil(ingredient_data['saturated_fats']/NUTRIENT_GRAMS)
    ...
    def adapter_recette_avec_llm(self, recipe: Recipe, substitutions: Dict) -> str:
