...
CREATE TABLE IF NOT EXISTS ${DATABASE_NAME}.ANALYTICS.HIST_TRANSFORMATIONS (
	TRANSFORM_ID NUMBER(38,0) NOT NULL autoincrement start 1 increment 1 noorder,
	CONVERSATION_ID VARCHAR(16777216),
	USER_ID VARCHAR(16777216),
	RECIPE_ID NUMBER(38,0),
	ORIGINAL_NAME VARCHAR(16777216),
	TRANSFORMED_NAME VARCHAR(16777216),
	SUCCESS BOOLEAN,
	MESSAGE VARCHAR(16777216),
	TRANSFORM_TIMESTAMP TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP(),
